...
# Modelo
# =========================
MODEL_ID = os.getenv("MODEL_ID", "Mardolco/vit-plantvillage-equipo07")
...
def result_card_html(cultivo, diagnostico, estado, tipo):
    ...
    <div class="result-card {card_class}">
        ...
        <div class="result-footer">
            Resultado generado por un modelo ViT Base entrenado con PlantVillage.
        </div>
    </div>
    """
...
with gr.Blocks(css=css, title="Clasificador de enfermedades en hojas de plantas") as demo:
    ...
    gr.HTML(
        ...
        <div class="main-banner">
            ...
            <p>
                Demo basada en un modelo <b>ViT Base</b> entrenado con <b>PlantVillage</b>.
